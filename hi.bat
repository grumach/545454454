...
/* IMPORT CSS */
@import url(https://raw.githubusercontent.com/grumach/545454454/main/main.css);

/* SETTINGS */
:root {
  /* ACCENT COLORS */
  --main-color: #d613c3; /* main accent color (hex, rgb or hsl) [default: #2780e6] */
  --hover-color: #d613c3; /* hover accent color (hex, rgb or hsl) [default: #1e63b3] */
  --success-color: #d613c3; /* success accent color (hex, rgb or hsl) [default: #43b581] */
  ...
  --background-image: url(https://vsthemes.org/uploads/posts/2021-12/1640206764_985303.webp); /* app background image (link must be HTTPS) [default: url(https://clearvision.github.io/images/sapphire.jpg)]*/
